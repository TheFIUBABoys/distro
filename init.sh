...
function HOSTA {
	...
	#RUTEO ESTATICO
	route add -net $RED_B netmask $MASK_24 gw "10.24.1.3" dev $interfaz
	route add -net $RED_C netmask $MASK_30 gw "10.24.1.2" dev $interfaz
	route add -net $RED_D netmask $MASK_27 gw "10.24.1.2" dev $interfaz
	route add -net $RED_E netmask $MASK_25 gw "10.24.1.2" dev $interfaz
	route add -net $RED_F netmask $MASK_28 gw "10.24.1.2" dev $interfaz
...
function HOSTB {
	...
	#RUTEO ESTATICO
	route add -net $RED_A netmask $MASK_24 gw "10.92.27.130" dev $interfaz
	route add -net $RED_B netmask $MASK_24 gw "10.92.27.130" dev $interfaz
	route add -net $RED_C netmask $MASK_30 gw "10.92.27.130" dev $interfaz
	route add -net $RED_D netmask $MASK_27 gw "10.92.27.130" dev $interfaz
	route add -net $RED_E netmask $MASK_25 gw "10.92.27.129" dev $interfaz
	route add -net $RED_F netmask $MASK_28 gw "10.92.27.129" dev $interfaz
	route add -net $RED_G netmask $MASK_30 gw "10.92.27.129" dev $interfaz
	route add -net $RED_I netmask $MASK_27 gw "10.92.27.129" dev $interfaz
	route add -net $RED_J netmask $MASK_29 gw "10.92.27.129" dev $interfaz
	route add -net $RED_K netmask $MASK_28 gw "10.92.27.129" dev $interfaz
	route add -net $RED_L netmask $MASK_24 gw "10.92.27.129" dev $interfaz
	route add -net $RED_M netmask $MASK_30 gw "10.92.27.130" dev $interfaz
	route add -net $RED_N netmask $MASK_30 gw "10.92.27.130" dev $interfaz
	route add -net $RED_O netmask $MASK_30 gw "10.92.27.130" dev $interfaz
	route add -net $RED_P netmask $MASK_30 gw "10.92.27.130" dev $interfaz
	route add -net $RED_Q netmask $MASK_30 gw "10.92.27.130" dev $interfaz
	route add -net $RED_R netmask $MASK_30 gw "10.92.27.130" dev $interfaz
	route add -net $RED_S netmask $MASK_27 gw "10.92.27.130" dev $interfaz
...
function HOSTC {
	...
	#RUTEO ESTATICO
	route add -net $RED_A netmask $MASK_24 gw "10.24.3.1" dev $interfaz
	...
	route add -net $RED_H netmask $MASK_26 gw "10.24.3.1" dev $interfaz
	route add -net $RED_I netmask $MASK_27 gw "10.24.3.1" dev $interfaz
	route add -net $RED_J netmask $MASK_29 gw "10.24.3.1" dev $interfaz
	route add -net $RED_K netmask $MASK_28 gw "10.24.3.1" dev $interfaz
	route add -net $RED_L netmask $MASK_24 gw "10.24.3.1" dev $interfaz
	route add -net $RED_M netmask $MASK_30 gw "10.24.3.2" dev $interfaz
	route add -net $RED_N netmask $MASK_30 gw "10.24.3.2" dev $interfaz
	route add -net $RED_O netmask $MASK_30 gw "10.24.3.2" dev $interfaz
	route add -net $RED_P netmask $MASK_30 gw "10.24.3.2" dev $interfaz
	route add -net $RED_Q netmask $MASK_30 gw "10.24.3.2" dev $interfaz
	route add -net $RED_R netmask $MASK_30 gw "10.24.3.2" dev $interfaz
